<x-front-layout>
    ...
    <div id="Contact" class="container max-w-[1130px] mx-auto flex flex-wrap xl:flex-nowrap justify-between gap-[50px] relative z-10">
        ...
        <form class="flex flex-col p-[30px] rounded-[20px] gap-[18px] bg-white shadow-[0_10px_30px_0_#D1D4DF40] w-full md:w-[700px] shrink-0"
              action="{{ route('front.appointment_store') }}" method="POST">
            @csrf
            @method('POST')
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <div
                        ...
                        <input type="text" name="name" id="name"
                               class="w-full font-semibold bg-white outline-none appearance-none placeholder:font-normal placeholder:text-cp-black"
            ...
            <div class="flex items-center gap-[18px]">
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <div
                        ...
                        <button type="button" id="dateButton" class="w-full p-0 text-left bg-transparent border-none outline-none">Choose the
                            date</button>
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <div
                        ...
                        <select name="product_id" id="product_id"
                                class="appearance-none outline-none w-full invalid:font-normal font-semibold px-[10px] -mx-[10px]" required>
            ...
            <div class="flex flex-col w-full gap-2">
                ...
                <div
                    ...
                    <textarea name="brief" id="brief" rows="6"
                              class="w-full font-semibold bg-white outline-none appearance-none resize-none placeholder:font-normal placeholder:text-cp-black"
