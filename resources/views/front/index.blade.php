            ...
            @forelse ($principles as $principle)
                <div
                    ...
                    <div class="thumbnail h-[200px] flex shrink-0 overflow-hidden">
                        <img src="{{ asset($principle->thumbnail) }}" class="object-cover object-center w-full h-full" alt="thumbnails">
                    </div>
                    <div class="flex flex-col p-[0_30px_30px_30px] gap-5">
                        <div class="w-[55px] h-[55px] flex shrink-0 overflow-hidden">
                            <img src="{{ asset($principle->icon) }}" class="object-contain w-full h-full" alt="icon">
                        </div>
            ...
            <div class="flex flex-wrap items-center justify-between p-[10px]">
                @forelse ($statistics as $statistic)
                    <div class="card w-[200px] flex flex-col items-center gap-[10px] text-center">
                        <div class="w-[55px] h-[55px] flex shrink-0 overflow-hidden">
                            <img src="{{ asset($statistic->icon) }}" class="object-contain w-full h-full" alt="icon">
                        </div>
        ...
        @forelse ($products as $product)
            <div class="product flex flex-wrap justify-center items-center gap-[60px] even:flex-row-reverse">
                <div class="w-[470px] h-[550px] flex shrink-0 overflow-hidden">
                    <img src="{{ asset($product->thumbnail) }}" class="object-contain w-full h-full" alt="thumbnail">
                </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="w-[90px] h-[90px] rounded-full overflow-hidden">
                                <img src="{{ asset($team->avatar) }}" class="object-cover object-center w-full h-full" alt="photo">
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div class="testimonial-container flex flex-col gap-[112px] w-[565px]">
                        <div class="flex flex-col gap-[30px]">
                            <div class="overflow-hidden h-9">
                                <img src="{{ asset($testimonial->client->logo) }}" class="object-contain" alt="icon">
                            </div>
                            ...
                            <div class="flex items-center justify-between pl-[30px]">
                                <div class="flex items-center gap-6">
                                    <div class="w-[60px] h-[60px] flex shrink-0 rounded-full overflow-hidden">
                                        <img src="{{ asset($testimonial->client->avatar) }}" class="object-cover w-full h-full" alt="photo">
                                    </div>
                    ...
                    <div class="testimonial-thumbnail w-[470px] h-[550px] rounded-[20px] overflow-hidden bg-[#D9D9D9]">
                        <img src="{{ asset($testimonial->thumbnail) }}" class="object-cover object-center w-full h-full" alt="thumbnail">
                    </div>
                </div>
            @empty
            @endforelse
                ...
                <div class="flex flex-col gap-[30px] sm:w-[603px] shrink-0">
                    <div class="flex flex-col w-full p-5 bg-white rounded-2xl">
                        ...
                        <div id="accordion-faq-1" class="accordion-content hide">
                            <p class="leading-[30px] text-cp-light-grey pt-[14px]">We want to protect our and clients assets to the max level so that
                                we chose the best one from Jakarta, Indonesia will also protect post building finished completed ahead one.</p>
                        </div>
                    </div>
                    <div class="flex flex-col w-full p-5 bg-white rounded-2xl">
