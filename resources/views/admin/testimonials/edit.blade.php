                ...
                <form method="POST" action="{{ route('admin.testimonials.update', $testimonial) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <select name="project_client_id" id="project_client_id" class="w-full py-3 pl-3 border rounded-lg border-slate-300">
                            <option selected value="{{ $testimonial->client->id }}">{{ $testimonial->client->name }}</option>
                    ...
                    <div class="mt-4">
                        ...
                        <img src="{{ asset($testimonial->thumbnail) }}" alt="thumbnail" class="rounded-2xl object-cover w-[90px] h-[90px]">
