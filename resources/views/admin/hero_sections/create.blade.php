            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.hero_sections.store') }}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <x-text-input id="heading" class="block mt-1 w-full" type="text" name="heading" :value="old('heading')" required autofocus
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="banner" class="block mt-1 w-full" type="file" name="banner" required autofocus
                                      autocomplete="banner" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="subheading" class="block mt-1 w-full" type="text" name="subheading" :value="old('subheading')" required autofocus
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="achievement" class="block mt-1 w-full" type="text" name="achievement" :value="old('achievement')" required
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="path_video" class="block mt-1 w-full" type="text" name="path_video" :value="old('path_video')" required autofocus
